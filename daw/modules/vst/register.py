...
def unregister():
    ...
    # Fecha qualquer plugin VST nativo ainda carregado (editor aberto,
    # thread de áudio, DLL) -- sem isso pode ficar handle nativo
    # pendurado mesmo depois do addon ser desativado/recarregado.
    try:
        from .native_engine import shutdown_worker
        shutdown_worker()
    except Exception as e:
        print(f"[DAW][vst] Falha ao desligar motor de VST: {e}")
